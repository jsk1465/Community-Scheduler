...
const tagsWithMandatoryType = ['implements', 'type'];
const tagsWithOptionalType = ['enum', 'member', 'var', 'module', 'typedef', 'augments', 'extends', 'class', 'constructor', 'constant', 'const', 'namespace', 'param', 'arg', 'argument', 'property', 'prop', 'returns', 'return', 'throws', 'exception', 'yields', 'yield', // Todo: Omit these GCC specific items when in non-GCC mode after landing https://github.com/gajus/eslint-plugin-jsdoc/issues/356
'package', 'private', 'protected', 'public', 'static'];
const namepathDefiningTags = ['external', 'host', 'name', 'typedef', 'event', 'class', 'constructor', 'constant', 'const', 'callback', 'function', 'func', 'method', 'interface', 'member', 'var', 'mixin', 'namespace'];
const tagsWithOptionalNamepath = [...namepathDefiningTags, 'alias', 'augments', 'extends', // `borrows` has a different format, however, so needs special parsing
'borrows', 'emits', 'fires', 'lends', 'listens', 'memberof', 'memberof!', 'mixes', 'see', 'this'];
const tagsWithMandatoryNamepath = ['callback', 'external', 'host', 'name', 'typedef'];
const tagsWithMandatoryTypeOrNamepath = ['alias', 'augments', 'extends', 'borrows', 'external', 'host', 'lends', 'memberof', 'memberof!', 'mixes', 'name', 'this', 'typedef'];
